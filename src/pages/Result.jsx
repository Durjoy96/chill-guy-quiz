...
const Result = () => {
  const { points } = useContext(contextProvider);
          ...
          <div className="py-4 text-center">
            {percentage <= 40 ? (
              <p className="text-base font-normal text-base-content">
                You’re a bit too high-strung. Maybe try yoga or deep breathing!
              </p>
            ) : percentage <= 70 ? (
              <p className="text-base font-normal text-base-content">
              ...
              <p className="text-base font-normal text-base-content">
                Congratulations, you’re the Ultimate Chill Guy! Nothing fazes
                you!
              </p>
            )}
          </div>
